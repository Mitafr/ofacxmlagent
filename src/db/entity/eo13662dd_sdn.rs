...
pub enum Relation {
    #[sea_orm(belongs_to = "super::eo13662dd::Entity", from = "Column::Eo13662ddId", to = "super::eo13662dd::Column::Id", on_update = "Restrict", on_delete = "Restrict")]
    Eo13662dd,
...
impl Linked for SdnToEo13662dd {
    ...
    fn link(&self) -> Vec<RelationDef> {
        vec![
            ...
            Entity::belongs_to(super::eo13662dd::Entity).from(Column::Eo13662ddId).to(super::eo13662dd::Column::Id).into(),
        ]
    }
}
